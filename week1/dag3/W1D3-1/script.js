let person = { name: "Geeske", age: 30, evaluations: [7, 10, 9], kleuren: [] };
console.log(person);
...
console.log("1e temp. kat 2:", catBreeds[1].temperament[0]);
console.log(
  "laatste temp. kat 3:",
  catBreeds[2].temperament[catBreeds[2].temperament.length - 1]
);
console.log("favo voer kat 3:", catBreeds[2].food.favourite_food);
